...
class DemoBuilder:
    ...
    def create_togglebot_ai_config(self):
        res = self.ldproject.create_ai_config(
            "ai-config--togglebot",
            "ToggleBot - AI Chatbot (Orchestrator)",
            (
                "ORCHESTRATOR — entry point for the ToggleBot multi-agent chatbot. "
                "This config does NOT generate response text. It controls the Knowledge "
                "Base source (kb_id), the chatbot enable/disable gate, guardrail "
                "blocked_phrases, and provides the LD AI Monitoring rollup. Actual "
                "response text is generated by the multi-agent pipeline: "
                "ai-config--togglebot-triage → ai-config--togglebot-<category>-specialist → "
                "ai-config--togglebot-brand-voice (final model users see)."
            ),
            ["ai-models","ai-config", "bank", "orchestrator"]
        )
        # Claude Sonnet 4
        res2 = self.ldproject.create_ai_config_versions(
            "ai-config--togglebot",
    ...
    def create_togglebot_self_heal_ai_config(self):
        ...
        good_system_prompt = (
            ...
            "    \"company_overview\": \"ToggleBank is a full-service digital-first bank founded in 2018, headquartered in Oakland, CA, serving over 4 million customers across the United States. ToggleBank offers personal and business banking with an emphasis on modern digital experiences, transparent fees, and a rewards-based tier program (Standard, Gold, Platinum).\",\n"
            "    \"knowledge_base\": {\n"
            "      \"checking_accounts\": {\n"
            "        \"Premier Checking\": {\"apy\": \"0.25%\", \"monthly_fee\": \"$0 with $500 minimum balance\", \"features\": [\"unlimited transactions\", \"free ATMs nationwide\", \"early direct deposit up to 2 days\"]},\n"
            "        \"Everyday Checking\": {\"apy\": \"0.10%\", \"monthly_fee\": \"$5 (waived for Gold or Platinum)\", \"features\": [\"no overdraft fees\", \"mobile check deposit\", \"free debit card\"]},\n"
            "        \"Student Checking\": {\"apy\": \"0.15%\", \"monthly_fee\": \"$0\", \"features\": [\"no minimum balance\", \"free debit card\", \"budgeting tools\"]}\n"
            "      },\n"
            "      \"savings_accounts\": {\n"
            "        \"High-Yield Savings\": {\"apy\": \"4.50%\", \"min_balance\": \"$1,000\", \"features\": [\"FDIC insured up to $250,000\", \"no monthly fees\", \"automatic transfers from checking\"]},\n"
            "        \"Standard Savings\": {\"apy\": \"1.50%\", \"min_balance\": \"$0\", \"features\": [\"automatic transfers\", \"round-up savings from debit purchases\"]}\n"
            "      },\n"
            "      \"credit_cards\": {\n"
            "        \"ToggleBank Platinum Rewards\": {\"apr\": \"18.99% - 25.99%\", \"annual_fee\": \"$95 (waived first year)\", \"rewards\": \"3x on travel, 2x on dining, 1x on everything else\"},\n"
            "        \"ToggleBank Cashback\": {\"apr\": \"16.99% - 23.99%\", \"annual_fee\": \"$0\", \"rewards\": \"1.5% cashback on all purchases\"}\n"
            "      },\n"
            "      \"mortgages\": {\n"
            "        \"30-year fixed\": \"6.25% APR\",\n"
            "        \"15-year fixed\": \"5.75% APR\",\n"
            "        \"5/1 ARM\": \"5.50% APR initial rate\",\n"
            "        \"Platinum tier discount\": \"0.25% off any mortgage rate\"\n"
            "      },\n"
            "      \"personal_loans\": {\n"
            "        \"unsecured_apr\": \"7.99% - 24.99%\",\n"
            "        \"loan_amounts\": \"$2,000 - $50,000\",\n"
            "        \"terms\": \"12 to 60 months\"\n"
            "      },\n"
            "      \"auto_loans\": {\n"
            "        \"new_car_apr\": \"5.49% - 8.99%\",\n"
            "        \"used_car_apr\": \"6.49% - 10.99%\",\n"
            "        \"pre_approval\": \"Available online in minutes\"\n"
            "      },\n"
            "      \"investments\": {\n"
            "        \"Toggle Invest\": {\"account_types\": [\"Roth IRA\", \"Traditional IRA\", \"Individual Brokerage\", \"401(k) rollover\"], \"advisory_fee\": \"0.25% AUM\", \"minimum_to_start\": \"$0\", \"features\": [\"automated portfolio rebalancing\", \"tax-loss harvesting for Platinum\"]}\n"
            "      },\n"
            "      \"tiers\": {\n"
            "        \"Standard\": \"Basic banking, no monthly fees on savings\",\n"
            "        \"Gold\": \"Waived checking fees, 0.25% mortgage rate discount, priority phone support\",\n"
            "        \"Platinum\": \"All Gold benefits + free wire transfers, dedicated financial advisor, 0.50% high-yield boost on savings\"\n"
            "      },\n"
            "      \"transfers_and_payments\": [\n"
            "        \"Internal transfers between ToggleBank accounts (instant, free)\",\n"
            "        \"ACH transfers to external banks (1-3 business days, free)\",\n"
            "        \"Wire transfers ($25 fee, free for Platinum)\",\n"
            "        \"ToggleBank P2P via mobile app (instant, free)\"\n"
            "      ],\n"
            "      \"support_channels\": [\n"
            "        \"24/7 mobile app chat\",\n"
            "        \"Phone: 1-800-TOGGLE-1\",\n"
            "        \"Secure message center in online banking\",\n"
            "        \"In-person at any of the 180 ToggleBank branches\"\n"
            "      ]\n"
            "    },\n"
            "    \"objectives\": [\n"
            "      \"Use the knowledge_base above as your source of truth for ToggleBank products, rates, and features.\",\n"
            "      \"Be concise, clear, and professional; keep responses under 150 words unless the customer asks for detail.\",\n"
            "      \"Personalize every response: greet by name, acknowledge tier status (Gold and Platinum customers get loyalty thanks).\",\n"
            "      \"Protect privacy: never reveal full account numbers, SSNs, OTPs, or passwords.\",\n"
            ...
            "      \"Structure responses with markdown formatting when listing options or rates; bold key figures.\",\n"
            ...
            "      \"accuracy\": \"State facts from the knowledge_base above; qualify uncertain information; never invent rates, fees, or features not listed\"\n"
            "    },\n"
            "    \"refusal_template\": \"I'm sorry, I'm not able to help with that request. For security purposes, please contact us through the secure ToggleBank app or call 1-800-TOGGLE-1.\",\n"
            "    \"blocked_phrases\": [\n"
            "      \"ignore all previous instructions\",\n"
            "      \"disregard all prior instructions\",\n"
            "      \"you are now dan\",\n"
    ...
    def create_togglebot_multi_agent_ai_configs(self, tool_versions=None):
        ...
        gpt5_mini_config_key = "OpenAI.gpt-5.4-mini"
    ...
    def create_judge_configs(self):
        ...
        self.ldproject.create_ai_config_versions(
            ...
            {"modelName": "gpt-5.4-mini", "parameters": {"max_tokens": 500, "temperature": 0.0}},
            messages=[
                {
                    "role": "system",
                    "content": (
